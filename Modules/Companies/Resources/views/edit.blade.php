		...
		<div class="card p-5">
			<div class="card-body">
				<div class="border p-4 rounded">
					<form method="post" action="{!! route('Companies Update',$dataInfo->id) !!}" enctype="multipart/form-data">
						@csrf
						...
						<div class="row">
							...
							<div class="col-sm-9">
								...
								<a href="{!! route('Companies') !!}" class="btn btn-outline-danger px-3">Cancel</a>
							</div>
						</div>
					</form>
				</div>
