				...
				<table class="table mb-0 table-hover">
					...
					<tbody>
						...
						<tr>
							...
							<td>
								@if(!empty($list->photo))
								<img src="{!! asset('uploads/companies/' . $list->photo) !!}" height="30">
								@endif
							</td>
							<td>
								...
								<td>
									<div class="dropdown">
										...
										<ul class="dropdown-menu" style="margin: 0px;">
											<li><a class="dropdown-item" href="{!! route('Companies Edit', $list->id) !!}">Edit</a>
											</li>
											<li><a class="dropdown-item confirmDelete"
												href="{!! route('Companies Delete', $list->id) !!}">Delete</a>
											</li>
										</li>
									</ul>
								</div>
